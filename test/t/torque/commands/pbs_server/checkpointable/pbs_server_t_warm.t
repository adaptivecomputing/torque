...
plan('no_plan');
setDesc("pbs_server -t warm (Rerunnable jobs)");
...
# Commands
my $pbs_server_cmd   = "pbs_server -t warm";
...
ok($job_info{ $job_ids[0] }{ 'job_state' } eq 'Q', "Checking job '$job_ids[0]' for job state running")
