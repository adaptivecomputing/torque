...
my %jobId = runCommandAs($props->get_property('User.1'),'echo /bin/sleep 60 | qsub -l walltime=4:00:00');
...
cmp_ok($walltime,'eq',"04:00:00",'Checking for Resource_List.walltime [04:00:00]');
