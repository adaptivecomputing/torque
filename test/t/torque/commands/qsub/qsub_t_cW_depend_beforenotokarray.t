...
plan('no_plan');
setDesc('Qsub -t -W (beforenotokarray)');
...
$qref = {
          'flags' => "-W depend=beforenotokarray:$jid1",
        };
$jid2 = qsub($qref);
...
cmp_ok($qhash{ $jid2 }{ 'depend'  }, 'eq', "beforenotokarray:$jid1\@$test_host", "Verifying the dependent job:$jid2 'depend'");
