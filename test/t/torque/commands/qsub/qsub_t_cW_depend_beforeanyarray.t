...
plan('no_plan');
setDesc('Qsub -t -W (beforeanyarray)');
...
$qref = {
          'flags' => "-W depend=beforeanyarray:$jid1",
        };
$jid2 = qsub($qref);
...
cmp_ok($qhash->{ $jid2 }{ 'depend'  }, 'eq', "beforeanyarray:$jid1\@$test_host", "Verifying the dependent job:$jid2 'depend'");
