...
# JR-TRQ-503              "$testbase/qsub_cS.t",
              ...
              "$testbase/qsub_t_cW_depend_beforeanyarray.t",
              "$testbase/qsub_t_cW_depend_beforenotokarray.t",
              "$testbase/qsub_t_cW_depend_beforeokarray.t",
              "$testbase/qsub_t_cW_depend_beforestartarray.t",
              "$testbase/qsub_u.t",
              "$testbase/qsub_v.t",
# JR-TRQ-504              "$testbase/qsub_cV.t",
