...
int mom_jobstarter_execute_job(mom_job *pjob, char *shell, char *arg[], struct var_table *vtable);
...
int TMomFinalizeJob1(mom_job *pjob, pjobexec_t *TJE, int *SC);
