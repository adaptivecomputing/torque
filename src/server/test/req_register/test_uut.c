...
void removeAfterAnyDependency(const char *pJob,void *targetJob);
...
START_TEST(remove_after_any_test)
  ...
  removeAfterAnyDependency(pJob->ji_qs.ji_jobid,pTJob);
  ...
  removeAfterAnyDependency(pJob->ji_qs.ji_jobid,pOJob);
