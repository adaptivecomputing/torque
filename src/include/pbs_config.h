...
#define PBS_BUILD_DATE "Sat Dec  8 06:46:21 MST 2012"

/* Define to the build directory */
#define PBS_BUILD_DIR "/sdb/dev/torque/actorque/torque.new"
...
#define PBS_SOURCE_DIR "/sdb/dev/torque/actorque/torque.new"
...
#define pam_get_user_2nd_arg_t const char
