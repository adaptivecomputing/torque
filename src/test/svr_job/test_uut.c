...
Suite *svr_job_suite(void)
  {
  Suite *s = suite_create("svr_job_suite methods");
...
int main(void)
  ...
  rundebug();
  sr = srunner_create(svr_job_suite());
  srunner_set_log(sr, "svr_job_suite.log");
