...
START_TEST(test_res_max_nodes)
  {
  char *copt = "s q one_nodeq resources_max.nodes = 1:ppn=32";
...
START_TEST(test_res_max_nodect)
  {
  char *copt = "s q one_nodeq resources_max.nodect = 1:ppn=32";
  int type, oper, errflg; 
  char *name = NULL;
  struct attropl *attribs = NULL;
...
START_TEST(test_res_max_procct)
  {
  char *copt = "s q one_nodeq resources_max.procct = 1:ppn=32";
  int type, oper, errflg; 
  char *name = NULL;
  struct attropl *attribs = NULL;
...
START_TEST(test_res_min_nodes)
  {
  char *copt = "s q one_nodeq resources_min.nodes = 1:ppn=32";
  int type, oper, errflg; 
  char *name = NULL;
  struct attropl *attribs = NULL;
...
START_TEST(test_res_min_nodect)
  {
  char *copt = "s q one_nodeq resources_min.nodect = 1:ppn=32";
  int type, oper, errflg; 
  char *name = NULL;
  struct attropl *attribs = NULL;
...
START_TEST(test_res_min_procct)
  {
  char *copt = "s q one_nodeq resources_min.procct = 1:ppn=32";
  int type, oper, errflg; 
  char *name = NULL;
  struct attropl *attribs = NULL;
